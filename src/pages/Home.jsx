    ...
    <>
      <section className="hero lg:text-center">
        ...
        <Button
          width="100"
          className={
            "talks-btn bg-blue-500 text-white text-sm lg:ps-2 lg:pe-2 lg:text-center rounded-xl absolute  lg:mt-4 lg:left-60 lg:ml-8 "
          }
        ...
        <Button
          width="100"
          className={
            "talks-btn bg-blue-500 text-white text-sm lg:ps-2 lg:pe-2 lg:text-center rounded-xl absolute  lg:mt-4 lg:right-60 lg:mr-16 "
          }
        >
          Open to Work
        </Button>
